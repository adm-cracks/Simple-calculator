...
function co_ke(s) {
    var con = document.getElementById("boc")
    con.style.background = s;
}

function co_dis(s) {
    var con = document.getElementById("di")
    con.style.background = s;
}

function co_ba(s) {
    var con = document.getElementById("bac")
    con.style.background = s;
}